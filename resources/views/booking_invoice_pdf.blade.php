    ...
    <tr  bgcolor="#E3E3E3" >
                        ...
                        <table width="100%" border="0"cellpadding="0" cellspacing="0">
                            <tr >
                                <td height="69">
                                    ...
                                    <tr>
                                        <td width="50" height="29"  style="font-weight:bolder; font-size:25px"><img src="{{asset('img/primespot_logo.png')}}" alt="primespot logo" width="180" title="printlabs logo" /> <br><br>INVOICE</td>
                            ...
                            <tr>
                                <td height="69">
                                    ...
                                    <tr>
                                        <td width="50" ><span style="font-size:15px; "> <span style="font-weight: bold; font-size:15px">BILL TO: </span><br> <span style="font-size: 16px">{{$booking->user->name}} <br> {{$booking->user->address}} <br> </span></span></td>
      ...
      <tr>
        <td>
            <table width="100%" border="1" cellpadding="0" cellspacing="0">
                ...
                {{-- <tr class="det" style="padding-top: 5px">
                    <td width="20%" class="question">Total Amount :</td>
                    <td>#{{$booking->items->sum('amount')}}</td>
                </tr> --}}
            </table>
        </td>
      </tr>
     ...
     <tr>
        <td><table width="100%" border="1" cellpadding="0" cellspacing="0">
            <tr>
                <td bgcolor="#E3E3E3" height="28" style="padding-left: 20px">Venue</td>
                <td bgcolor="#E3E3E3" height="28" align="right">Screen</td>
                <td bgcolor="#E3E3E3" height="28" align="right" style="padding-right: 20px">Amount</td>
            </tr>

            @foreach ($bookingItems as $val)
                <tr style="border-bottom: 1px solid #ccc;">
                    <td align="left" width="20" style="padding-left: 20px">{{$val->venue->name}}</td>
                    <td align="right" width="25">{{$val->screen->name}}</td>
                    <td align="right" width="15"> {{ App\Functions\Functions::formatCurrency($val->amount) }}</td>
                </tr>
            @endforeach
      ...
      <tr>
        <td height="69"><table width="500" border="1" align="right" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="30" align="right">&nbsp;<span style="font-size:20px; padding-right:10px"><span style="font-weight:bold; ">Total Amount:</span> N{{$booking->items->sum('amount')}} </td>
          </tr>
