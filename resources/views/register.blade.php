...
html, body {
	...
	background:
                ...
                url('./img/billboard.png') center/cover no-repeat;
}
		...
		<div class="form-container">
			<div class="form-inner">
                ...
                <form method="POST" id="register_customer" class="register_customer">
                    @csrf
                    @method('POST')
                    <div class="field col-lg-12 d-flex align-items-center mb-3">
                    ...
                    <div class="field btn">
                        ...
                        <input type="submit" id="loginBtn" name="login" value="Create Account" style="background-color:#11773b">
                    </div>
